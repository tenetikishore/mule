...
public abstract class AbstractOperationMessageProcessorTestCase extends AbstractMuleContextTestCase {
  ...
  public void before() throws Exception {
    ...
    when(extensionManager.getConfiguration(extensionModel, configurationModel, event)).thenReturn(configurationInstance);
    when(configurationProvider.get(anyObject())).thenReturn(configurationInstance);
    when(extensionManager.getConfigurationProvider(extensionModel, configurationModel)).thenReturn(of(configurationProvider));
